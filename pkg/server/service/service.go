...
func (m *Manager) getLoadBalancer(ctx context.Context, serviceName string, service *dynamic.ServersLoadBalancer, fwd http.Handler) (healthcheck.StatusBalancerHandler, error) {
	logger := log.FromContext(ctx)
